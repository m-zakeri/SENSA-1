...
metric_map = {
    ...
    'CSORD_LogCyclomatic': 'CSCC_LOG',  # Do not mentioned in paper
    'CSORD_LogCyclomaticStrict': 'CSCCS_LOG',  # Do not mentioned in paper
    'CSORD_LogCyclomaticModified': 'CSCCM_LOG',  # Do not mentioned in paper
    'CSORD_LogEssential': 'CSCCE_LOG',  # Do not mentioned in paper
    ...
    'CSORD_NumberOfClassConstructors': 'CSNOCC',
...
method_metrics_names = [
    # 1 Size/Count metrics
    # 1.1 Systematic count/size metrics
    'ATFD','FDP','CFNAMM','ATLD','CC','CDISP','CINT','CM','CYCLO'
    ,'FANIN','FANOUT','LOC','MaMCL','MeMCL','NMCS','NOLV','LOCNAMM'
    ,'LAA','MAXNESTING','CLNAMM','NOP','NOAV','CountLineBlank','NL','CountLineCodeDecl','CountLineCodeExe','NPATH',
'CountStmt','CountStmtDecl','CountStmtExe','CyclomaticStrict','CyclomaticModified','Essential','Knots','MaxEssentialKnots',
'RatioCommentToCode','CountPathLog'
